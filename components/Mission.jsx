...
import image6 from "/public/mission.jpg";
                ...
                <div className="flex flex-col items-center md:items-start md:flex-row w-full max-w-7xl mx-auto md:px-16">
                    <div className="md:w-2/3 text-left md:pr-10 mb-20">
                        ...
                        <p className="text-gray-600 mb-8">
                            In case of URGENT appointment, you can call us on +91 90560-66473,+91 90560-66373 for Tatkal admissions. You can also hand over the
                            applications in-person at Dharam Complex, G.T. Road, Kartarpur, Jalandhar, 144801 from 9 A.M to 5 P.M. Please carry copy of Aadhar card,
                            Driving License and two passport size Photos with your Tatkal application.
                            <b>Online registration is NOT REQUIRED for Tatkal.</b>
                        </p>
                        <button
