                ...
                <div className="flex flex-col items-center md:items-start md:flex-row w-full max-w-7xl mx-auto md:px-16">
                    <div className="md:w-2/3 text-left md:pr-10 mb-20">
                        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-800 leading-snug mb-4">
                            Introducing Refresher Course <span className="text-red-500"> in Heavy Motor Vehicle Driving</span>
                        </h2>
                        ...
                        <button
                            ...
                            className="bg-red-500 hover:bg-red-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg transform transition-transform duration-300"
                        >
                            Apply Now
                        </button>
                    </div>
